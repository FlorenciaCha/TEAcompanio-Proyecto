const words = ["CASA", "FLOR", "PELOTA", "ARBOL", "SOL", "LUNA", "AGUA","JUGUETE", "PERRO"];
const gridSize = 10; 
let wordGrid;
...
document.getElementById('volver').addEventListener('click', function() {window.location.href = '../todosJuegos.html';});