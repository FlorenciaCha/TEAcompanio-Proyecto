...
const backHomeButton = document.getElementById('volver');
const data = [
  "Avioncito",
  "Bloques",
  "Autito",
...
const drop = (e) => {
  ...
  //Win
  if (count == 3) {
    result.innerText = `Bien hecho!`;
    result.style.color = '#3F4DE5';
    stopGame();
    backHomeButton.addEventListener('click', () => {
      window.location.href = '../todosJuegos.html'; // Cambia 'index.html' por la URL de tu página principal
  });
  }
};
